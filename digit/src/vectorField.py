...
class VectorField():
    ...
    def get_magnitude(self):
        # Gets overall magnitude of vector field; field is of the form [x, z]
        avg_vector = self.get_avg_vector()
        # print (avg_vector)
        return self.interpolate_data(avg_vector.T @ avg_vector)

    def get_force_vector(self):
        # gets overall force vector of vector field
        avg_vector = self.get_avg_vector()
        return self.transform_data(avg_vector)

    def transform_data(self, data):
        # transforms vector into meaningful values
        return data
